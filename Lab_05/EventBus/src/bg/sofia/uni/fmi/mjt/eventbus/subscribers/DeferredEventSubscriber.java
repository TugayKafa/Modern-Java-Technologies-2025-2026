...
import bg.sofia.uni.fmi.mjt.eventbus.comparator.PriorityAndTimestampEventComparator;
...
public class DeferredEventSubscriber<T extends Event<?>> implements Subscriber<T>, Iterable<T> {
    ...
    private PriorityQueue<T> events;

    public DeferredEventSubscriber() {
        this.events = new PriorityQueue<>(new PriorityAndTimestampEventComparator());
    }
    ...
    public Iterator<T> iterator() {
        ...
        sorted.sort(new PriorityAndTimestampEventComparator());
